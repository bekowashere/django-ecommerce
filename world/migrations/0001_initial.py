    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency_name",
                    models.CharField(max_length=64, verbose_name="Currency Name"),
                ),
                (
                    "currency_symbol",
                    models.CharField(max_length=8, verbose_name="Currency Symbol"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "language_code",
                    models.CharField(max_length=4, verbose_name="Language Code"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "zoneName",
                    models.CharField(max_length=64, verbose_name="Timezone Name"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numeric_code",
                    models.CharField(max_length=4, verbose_name="Numeric Code"),
                ),
                (
                    "phone_code",
                    models.CharField(max_length=8, verbose_name="Phone Code"),
                ),
                ("capital", models.CharField(max_length=64, verbose_name="Capital")),
                ("region", models.CharField(max_length=64, verbose_name="Region")),
                (
                    "subregion",
                    models.CharField(max_length=64, verbose_name="Sub Region"),
                ),
                (
                    "latitude",
                    models.DecimalField(
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="world.timezone", verbose_name="Timezones"
                    ),
                ),
            ],
            options={
