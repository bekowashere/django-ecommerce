# Generated by Django 4.1.7 on 2023-04-06 18:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_image', models.ImageField(blank=True, default=account.models.default_seller_image_path, null=True, upload_to=account.models.upload_seller_image, validators=[django.core.validators.FileExtensionValidator(['png', 'jpg', 'jpeg'])], verbose_name='Company Image')),
                ('company_name', models.CharField(max_length=128, verbose_name='Company Name')),
                ('seller_slug', models.SlugField(verbose_name='Slug')),
                ('code', models.CharField(max_length=4, unique=True, verbose_name='Company Code')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('website_url', models.URLField(blank=True, help_text='www.my-site.com', null=True, verbose_name='Website')),
                ('phone_number', models.CharField(blank=True, max_length=32, null=True, verbose_name='Hidden Phone')),
                ('public_phone_number', models.CharField(blank=True, max_length=32, null=True, verbose_name='Public Phone')),
                ('public_email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Email Address')),
                ('fax_number', models.CharField(blank=True, max_length=32, null=True, verbose_name='Fax')),
                ('street_address_1', models.CharField(blank=True, max_length=256, null=True, verbose_name='Street Address 1')),
                ('street_address_2', models.CharField(blank=True, max_length=256, null=True, verbose_name='Street Address 2')),
                ('postal_code', models.CharField(blank=True, max_length=32, null=True, verbose_name='Postal Code')),
                ('city', models.CharField(blank=True, help_text='Ex: Los Angeles', max_length=64, null=True, verbose_name='City')),
                ('city_area', models.CharField(blank=True, help_text='Ex: California', max_length=64, null=True, verbose_name='City Area')),
                ...
                ('languages', models.ManyToManyField(blank=True, help_text='Select spoken languages', to='world.language', verbose_name='Languages')),
            ],
            options={
                'verbose_name': 'Seller',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='adddress_country', to='world.country', verbose_name='Country')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SellerUserImage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_id', models.UUIDField(default=uuid.uuid4, editable=False, verbose_name='Image ID')),
                ('image', models.ImageField(upload_to=account.models.upload_seller_multiple_image, validators=[django.core.validators.FileExtensionValidator(['png', 'jpg', 'jpeg'])], verbose_name='Image')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seller_multiple_images', to='account.selleruser', verbose_name='Seller')),
            ],
            options={
                'verbose_name': 'Seller Image',
                'verbose_name_plural': 'Seller Images',
            },
        ),
        migrations.CreateModel(
            name='CustomerUser',
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=32, null=True, verbose_name='Phone')),
                ('note', models.TextField(blank=True, null=True, verbose_name='Admin Note')),
